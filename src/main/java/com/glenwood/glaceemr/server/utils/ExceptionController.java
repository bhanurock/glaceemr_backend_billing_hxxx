...
public class ExceptionController {
     ...
     @Resource
     BillingResponseBean emrResponseBean;
     ...
     public @ResponseBody BillingResponseBean handleCustom(CustomException ex) {
    	 logger.error("", ex);
    	 ex.printStackTrace();
     ...
     public @ResponseBody BillingResponseBean handleCustomException(Exception ex) {
    	 logger.error("", ex);
    	 ex.printStackTrace();
         emrResponseBean.setSuccess(false);
         emrResponseBean.setData(null);
