...
public class EnsBillsDetails {
	...
	@Column(name="ens_file_id")
	private Integer ensFileId;
	...
	public Integer getEnsFileId() {
		return ensFileId;
	}

	public void setEnsFileId(Integer ensFileId) {
		this.ensFileId = ensFileId;
	}
}
