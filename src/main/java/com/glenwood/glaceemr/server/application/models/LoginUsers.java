...
public class LoginUsers {
	...
	@Column(name="login_users_ipad_home_page")
	private String loginUsersIpadHomePage;

	@Column(name="login_users_office_otp")
	private String loginUsersOfficeOtp;

	@Column(name="login_users_incorrect_login_attempt")
	private Integer loginUsersIncorrectLoginAttempt;
	...
	public String getLoginUsersIpadHomePage() {
		return loginUsersIpadHomePage;
	}

	public void setLoginUsersIpadHomePage(String loginUsersIpadHomePage) {
		this.loginUsersIpadHomePage = loginUsersIpadHomePage;
	}

	public String getLoginUsersOfficeOtp() {
		return loginUsersOfficeOtp;
	}

	public void setLoginUsersOfficeOtp(String loginUsersOfficeOtp) {
		this.loginUsersOfficeOtp = loginUsersOfficeOtp;
	}

	public Integer getLoginUsersIncorrectLoginAttempt() {
		return loginUsersIncorrectLoginAttempt;
	}

	public void setLoginUsersIncorrectLoginAttempt(
			Integer loginUsersIncorrectLoginAttempt) {
		this.loginUsersIncorrectLoginAttempt = loginUsersIncorrectLoginAttempt;
	}
