...
public class EntityGenerator {
	...
	public EntityGenerator() {
		try {
			...
			con = DriverManager.getConnection("jdbc:postgresql://192.168.2.3:5432/billing_central", "glace", "glacenxt");
...
//		entityGenerator.getTablesList();
	...
	private void createEntityFiles(String listOfTables) throws Exception {
		...
		while( rst.next() ) {
			File file = new File("/home/software/Documents/myEntity" + rst.getString(1) );
			if( !file.exists() ) {
				file.createNewFile();
			}
