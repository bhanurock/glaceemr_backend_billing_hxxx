...
public class OpeanProblemsBean {
    ...
    Integer posType;
    String eClaimId;
    Integer lastActionTaken;
    Integer arCategoryId;
    Integer problemId;
    
	public OpeanProblemsBean(Integer ptregid, Integer serviceId, String serviceStatus, String accountno, String lastName, String firstName,
			String middleName, String state, String denialReasonCode, String denialDescription, String denialDOP, Long serviceCount,
			String submitStatus, String dos, Double charges, Double copay, String primaryInsurance, String primInsID,
			String secondaryInsurance, String secInsID, String posId, String pos, Long claimCount, Long medclaimCount,
			Long dnlCount, Long nonServiceId, String cpt, String mod1, String dx1, String dx2, String dx3, String dx4, String bdoctor,
			String sdoctor, String mednotes, String action_type, String action_notes, String action_date,Double primaryPaidAmount,
			String claimId,String reference,String cptDescription,Integer unit,Double allowed, Double secPaidAmount, Double insBal, 
			String acctTypeId, Integer posType) {
		super();
	...
	public Integer getLastActionTaken() {
		return lastActionTaken;
	}
	public void setLastActionTaken(Integer lastActionTaken) {
		this.lastActionTaken = lastActionTaken;
	}
	public Integer getArCategoryId() {
		return arCategoryId;
	}
	public void setArCategoryId(Integer arCategoryId) {
